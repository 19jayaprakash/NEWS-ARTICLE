  ...
  return (
   ...
   <Head>
    ...
    <main>
        <h1>{title}</h1>
        <Alert>
            This is page uses <strong>getStatisProps</strong> for very high page loading speed and <strong>incremental static regeneration</strong> to show data not older than <strong>5 Minutes</strong>.
        </Alert>
