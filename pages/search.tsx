...
async function handleSubmit(e:FormEvent<HTMLFormElement>) {
  ...
  return (
    ...
    <Head>
      ...
      <h1>Search News</h1>  
      <Alert>
        This is page uses <strong>client-side data fetchimg</strong>to show fresh data for every search.
        Requests are handles by our backend via <strong>API routes</strong>.
      </Alert>
      <Form onSubmit={handleSubmit}>
        <Form.Group className="mb-3" controlId="search-input">
          <Form.Label>Search query</Form.Label>
          <Form.Control name="searchQuery"
          placeholder="E.g. sports, plants, ..."/>
        </Form.Group>
